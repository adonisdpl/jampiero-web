...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-[#FDF6EC]">
      {/* Header rouge avec avatar */}
      <div className="bg-[#C0392B] px-6 pt-6 pb-16">
        <button onClick={() => router.push('/client')} className="text-white/80 text-sm mb-4 hover:text-white block">← Retour</button>
        <div className="flex flex-col items-center">
          ...
          <p className="text-white/70 text-xs mt-1 tracking-widest">Membre depuis {memberSince}</p>
        </div>
      </div>
      ...
      <div className="max-w-lg mx-auto px-4 -mt-6">
        ...
        <button
          onClick={signOut}
          className="w-full border border-[#E8D5C4] rounded-xl py-3 text-sm text-[#7B7B7B] hover:text-[#C0392B] hover:border-[#C0392B] transition-colors mb-8">
          Se déconnecter
        </button>

        <p className="text-center text-xs text-[#BDBDBD] tracking-widest pb-8">
